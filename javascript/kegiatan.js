$(document).ready(function () {
        ...
        "columns": [
        	...
        	{ "data":"folder" },
        	{
        		...
        		render: function ( data, type, row ) {
        			return `
        				<img src="${base_url + 'uploads/kegiatan/' + data.folder + '/' + data.foto}" alt="company" class="img-responsive" width="25%">
        			`;
        		}
        	},
        	{
    ...
    $(document).on('click', '.btn-hapus', function () {
        ...
        xhr.open("POST", base_url + 'api/Api/kegiatan', true);
        xhr.send(formData);
        return false;
    });
    ...
    $('#kegiatan-form').submit(function () {
        ...
        formData.append("folder", $('#kegiatan-folder').val());
