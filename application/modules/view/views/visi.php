<div class="row">
		...
		<div class="card-box">
			<form id="edit-form">
        		...
        		<div class="form-group">
        			...
        			<textarea name="edit-visi" id="edit-visi" class="form-control" required cols="30" rows="10"></textarea>
        		</div>
        		<div class="form-group">
	...
	<div class="col-12 col-xl-8">
		<div class="card-box">
        	...
        	<table id="t-visi" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
				<thead>
					<tr>
						<th>No</th>
						<th>Visi</th>
